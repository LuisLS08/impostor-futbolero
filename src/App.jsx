...
const TEMAS_FUTBOL = [
  {
    ...
    conceptos: [
      ...
      "Jürgen Klopp", "Zinedine Zidane", "Cholo Simeone", "Luis Enrique", "Xavi Hernández", 
      "Mikel Arteta", "Mauricio Pochettino", "Marcelo Bielsa", "Marcelo Gallardo", 
      "Carlos Bilardo", "César Menotti", "Jorge Sampaoli", "José Pékerman", "Ricardo Gareca", 
      "Jorge Fossati", "Tata Martino", "Xabi Alonso", "Andrea Pirlo", "Hernán Crespo", 
      "Martín Demichelis", "Fernando Gago"
    ]
  },
  {
    ...
    conceptos: [
      ...
      "Cesc Fàbregas", "David Silva", "Fernando Torres", "David Villa", "Samuel Eto'o", 
      "Didier Drogba", "Yaya Touré", "Iker Casillas", "Gianluigi Buffon", "Oliver Kahn", 
      "Daniele De Rossi", "Giorgio Chiellini", "Leonardo Bonucci", "Mario Balotelli", 
      "Wesley Sneijder", "Robin van Persie", "Bastian Schweinsteiger", "Michael Ballack", 
      "John Terry", "Rio Ferdinand", "Steven Gerrard", "Frank Lampard", "David Beckham", 
      "Michael Owen", "Ryan Giggs", "Raúl González", "Carles Puyol", "Diego Forlán", 
      "Patrick Kluivert", "Kaká", "Luis Figo"
    ]
  },
  {
    ...
    conceptos: [
      ...
      "Hugo Lloris", "Olivier Giroud", "Ousmane Dembélé", "Thomas Müller", "Philipp Lahm", 
      "Toni Kroos", "Andrés Iniesta", "Xavi Hernández", "Sergio Ramos", "Cafú", 
      "Roberto Carlos", "Ronaldo Nazário", "Ronaldinho", "Rivaldo", "Diego Maradona", 
      "Jorge Valdano", "Oscar Ruggeri", "Mario Kempes", "Ubaldo Fillol", "Thierry Henry", 
      "Patrick Vieira", "Didier Deschamps"
    ]
  },
  {
    categoria: "Jugadores Leyendas",
    conceptos: [
      "Pelé", "Cristiano Ronaldo", "Johan Cruyff", "Alfredo Di Stéfano", "Franz Beckenbauer", 
      "Michel Platini", "Gerd Müller", "Eusébio", "George Best", "Zico", "Socrates", 
      "Romário", "Neymar Jr", "Luis Suárez", "Edinson Cavani", "Enzo Francescoli", 
      "Carlos Valderrama", "Iván Zamorano", "Marcelo Salas", "Alexis Sánchez", "Arturo Vidal", 
      "Hugo Sánchez", "Radamel Falcao", "James Rodríguez", "Teófilo Cubillas", "Paolo Guerrero", 
      "Claudio Pizarro", "Lev Yashin", "Peter Schmeichel", "Paolo Maldini", "Franco Baresi", 
      "Alessandro Nesta", "Fabio Cannavaro", "Virgil van Dijk", "Javier Zanetti", "Dani Alves", 
      "Marcelo", "Luka Modrić", "Kevin De Bruyne", "Paul Scholes", "Roy Keane", 
      "Harry Kane", "Alan Shearer", "Robert Lewandowski", "Karim Benzema", "Marco van Basten", 
      "Ruud Gullit", "Dennis Bergkamp", "Ruud van Nistelrooy"
    ]
  }
]
